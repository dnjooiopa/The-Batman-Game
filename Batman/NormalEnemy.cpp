...
void NormalEnemy::setEnemy(Texture * texture, Vector2u imageCount, float switchTime, float speed)
{
...
void NormalEnemy::setPosition(float posX)
{
	body.setPosition(posX, 700.0f - 1.5*animation.uvRect.height);
}


void NormalEnemy::Update(Vector2f playerPos, bool hit, float deltaTime)
{
...
void NormalEnemy::Draw(RenderWindow &window)
{
	window.draw(body);
}

void NormalEnemy::setSpeed(float speed)
{
	this->speed = speed;
}
